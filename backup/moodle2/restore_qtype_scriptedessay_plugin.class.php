 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_scriptedessay_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        return array(
            ...
            new restore_path_element('scriptedessay', $this->get_pathfor('/scriptedessay'))
        );
    }
    ...
    public function process_scriptedessay($data)
    {
         global $DB;
            ...
            {
                $data->questionid = $this->get_new_parentid('question');
                $newitemid = $DB->insert_record('question_scriptedessay', $data);
                $this->set_mapping('qtype_scriptedessay', $oldid, $newitemid);
            }
